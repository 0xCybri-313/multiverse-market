...
const Footer = () => {
  return (
    <footer className="bg-gray-900 py-10 text-gray-200">
      <div className="mx-auto max-w-7xl px-4 md:flex md:justify-between">
        {/*  info */}
        ...
        <div>
          ...
          <form action="" className="mt-4 flex">
            ...
            <button
              type="submit"
              className="rounded-r-md bg-red-600 px-4 text-white hover:bg-red-700"
            >
              Subscribe
            </button>
          </form>
      ...
      <div className="mt-8 border-t border-gray-700 pt-6 text-center text-sm">
        <p>
          ...
          <span className="text-red-500">Multiverse Market</span>. All rights
          reserved
        </p>
      </div>
    </footer>
