...
function ProductCard({ product }) {
  console.log(product);
  return (
    <div className="relative flex h-full cursor-pointer flex-col justify-between rounded-2xl border border-gray-100 bg-white p-4 transition-all hover:scale-105 hover:shadow-2xl">
      <img
